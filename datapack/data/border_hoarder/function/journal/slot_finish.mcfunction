# Add required properties to the transfer object
...
execute as @e[tag=bh_anchor,limit=1] \
    run data modify entity @s Items append from storage border_hoarder:temp transfer
