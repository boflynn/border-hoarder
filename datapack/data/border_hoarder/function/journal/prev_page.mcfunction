...
# execute as @s[scores={bh_click_cooldown=0}] run scoreboard players remove #global bh_page 1
scoreboard players remove #global bh_page 1
...
# Now that we're on the previous page, refill the chest
