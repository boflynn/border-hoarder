...
execute if data storage border_hoarder:temp items[0] \
    run function border_hoarder:check_item_discovered with storage border_hoarder:temp items[0]
...
execute if data storage border_hoarder:temp items[0] \
    run function border_hoarder:loop_inventory
